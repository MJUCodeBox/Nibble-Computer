...
public class JLE extends CUInstruction{
	...
	public void excute() {
		...
		if(zeroBitValue == EStatus.ZeroTrue.getValue()) {this.pc.setData(this.pc.getData()+1);}
		else if(signBitValue == EStatus.SignMinus.getValue()) {this.pc.setData(value);} // Minus : AC < CMP Value
